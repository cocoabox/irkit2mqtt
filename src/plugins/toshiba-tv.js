...
class ToshibaTV extends IrkitAppliance {
    ...
    action(action_name , args) {
        ...
        switch (action_name) {
            ...
            case 'play':
                return {single : this.constructor.#make_irkit_dict('play')};
            case 'pause':
                return {single : this.constructor.#make_irkit_dict('pause')};
            case 'fast_fwd':
                return {single : this.constructor.#make_irkit_dict('fast_fwd')};
            case 'rewind':
                return {single : this.constructor.#make_irkit_dict('rewind')};
            case 'next':
                return {single : this.constructor.#make_irkit_dict('next')};
            case 'prev':
                return {single : this.constructor.#make_irkit_dict('prev')};
            case 'tv_guide':
                return {single : this.constructor.#make_irkit_dict('tv_guide')};
            case 'vol_up':
                return adjust_volume('vol_up' , args[0]);
            case 'vol_down':
                return adjust_volume('vol_down' , args[0]);
            case 'ch_up':
                return {single : this.constructor.#make_irkit_dict('ch_up')};
            case 'ch_down':
                return {single : this.constructor.#make_irkit_dict('ch_down')};
            default:
                return;
        }
    }
